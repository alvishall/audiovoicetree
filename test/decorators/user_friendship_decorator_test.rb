...
class UserFriendshipDecoratorTest < Draper::TestCase
	context "#sub_message" do
		setup do
			@friend = create(:user, first_name: 'Mike')
		end
		...
		should "return the correct message" do
			assert_equal "Family request pending!", @decorator.sub_message
		end
	  ...
	  should "return the correct message" do
	  	assert_equal "You are family with Mike.", @decorator.sub_message
	   end
	  end
	end
